...
import net.aimn.materialdesign.stepper.StepMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setTitle("This is Material Design Demo");
                dialog.setMessage("Use Material Design");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.navigation_dashboard:
                        Intent intent = new Intent(MainActivity.this,StepMain.class);
